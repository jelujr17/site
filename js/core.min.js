...
!function (t, e) {
	...
	function k(t, e) {
		var n, i = a({}, t);
		for (n in e)
			r(e, n) && (Y(t[n]) && Y(e[n]) ? (i[n] = {},
				a(i[n], t[n]),
				a(i[n], e[n])) : null != e[n] ? i[n] = e[n] : delete i[n]);
		return i
	}
	function T(t) {
		null != t && this.set(t)
	...
	function x(t, e) {
		var n;
		return t && (n = c(e) ? P(t) : U(t, e),
			n && (ni = n)),
			ni._abbr
	}
	function U(t, e) {
		return null !== e ? (e.abbr = t,
			null != ii[t] ? (M("defineLocaleOverride", "use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale"),
				e = k(ii[t]._config, e)) : null != e.parentLocale && (null != ii[e.parentLocale] ? e = k(ii[e.parentLocale]._config, e) : M("parentLocaleUndefined", "specified parentLocale is not defined yet")),
			ii[t] = new T(e),
			x(t),
			ii[t]) : (delete ii[t],
				null)
	...
	function G(t, e) {
		if (null != e) {
			...
			null != ii[t] && (null != ii[t].parentLocale ? ii[t] = ii[t].parentLocale : null != ii[t] && delete ii[t]);
		return ii[t]
	}
	function P(t) {
		var e;
	...
	function rt(t, e) {
		...
		if ("string" == typeof e)
			if (/^\d+$/.test(e))
				...
				"number" != typeof e)
				return t;
		return n = Math.min(t.date(), et(t.year(), e)),
			t._d["set" + (t._isUTC ? "UTC" : "") + "Month"](e, n),
			t
	}
	function at(e) {
		return null != e ? (rt(this, e),
	...
	function ut(t) {
		return this._monthsParseExact ? (r(this, "_monthsRegex") || lt.call(this),
	...
	function ht(t) {
		var e, n = t._a;
		return n && -2 === d(t).overflow && (e = n[Wi] < 0 || n[Wi] > 11 ? Wi : n[xi] < 1 || n[xi] > et(n[Oi], n[Wi]) ? xi : n[Ui] < 0 || n[Ui] > 24 || 24 === n[Ui] && (0 !== n[Gi] || 0 !== n[Pi] || 0 !== n[Ci]) ? Ui : n[Gi] < 0 || n[Gi] > 59 ? Gi : n[Pi] < 0 || n[Pi] > 59 ? Pi : n[Ci] < 0 || n[Ci] > 999 ? Ci : -1,
	...
	function ft(e) {
		var n = $i.exec(e._i);
		return null !== n ? void (e._d = new Date(+n[1])) : (ct(e),
	...
	function Mt(t, e, n) {
		...
		return 1 > a ? (s = t.year() - 1,
			i = a + St(s, e, n)) : a > St(t.year(), e, n) ? (i = a - St(t.year(), e, n),
				s = t.year() + 1) : (s = t.year(),
					i = a),
		{
			week: i,
	...
	function kt(t) {
		...
		if (!t._d) {
			for (i = wt(t),
				...
				t._dayOfYear && (s = Yt(t._a[Oi], i[Oi]),
			...
			24 === t._a[Ui] && 0 === t._a[Gi] && 0 === t._a[Pi] && 0 === t._a[Ci] && (t._nextDay = !0,
				t._a[Ui] = 0),
				...
				(1 > s || s > 7) && (u = !0)) : (r = t._locale._week.dow,
					...
					null != e.d ? (s = e.d,
						(0 > s || s > 6) && (u = !0)) : null != e.e ? (s = e.e + r,
							(e.e < 0 || e.e > 6) && (u = !0)) : s = r),
			1 > i || i > St(n, r, a) ? d(t)._overflowWeeks = !0 : null != u ? d(t)._overflowWeekday = !0 : (o = Dt(n, i, s, r, a),
				t._a[Oi] = o.year,
		...
		for (s = $(e._f, e._locale).match(ri) || [],
			...
			r = s[n],
				...
				i && (a = o.substr(0, o.indexOf(i)),
					...
					l += i.length),
				ui[r] ? (i ? d(e).empty = !1 : d(e).unusedTokens.push(r),
					tt(r, i, e)) : e._strict && !i && d(e).unusedTokens.push(r);
		d(e).charsLeftOver = u - l,
			o.length > 0 && d(e).unusedInput.push(o),
			d(e).bigHour === !0 && e._a[Ui] <= 12 && e._a[Ui] > 0 && (d(e).bigHour = void 0),
	...
	function Gt(t) {
		...
		return t._locale = t._locale || P(t._l),
			null === e || void 0 === s && "" === e ? h({
				...
				_(e) ? new m(ht(e)) : (n(s) ? Wt(t) : s ? bt(t) : i(e) ? t._d = e : Pt(t),
					l(t) || (t._d = null),
					t))
	}
	function Pt(e) {
	...
	function zt(e, n) {
		...
		return this.isValid() ? null != e ? ("string" == typeof e ? e = Rt(Yi, e) : Math.abs(e) < 16 && (e = 60 * e),
			!this._isUTC && n && (i = jt(this)),
			this._offset = e,
			this._isUTC = !0,
			null != i && this.add(i, "m"),
			s !== e && (!n || this._changeInProgress ? ue(this, ne(e - s, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0,
				t.updateOffset(this, !0),
				this._changeInProgress = null)),
			this) : this._isUTC ? s : jt(this) : null != e ? this : NaN
	}
	function Zt(t, e) {
	...
	function Jt() {
		return this._tzm ? this.utcOffset(this._tzm) : "string" == typeof this._i && this.utcOffset(Rt(Si, this._i)),
			this
	}
	function Bt(t) {
		return this.isValid() ? (t = t ? Ft(t).utcOffset() : 0,
	...
	function ne(t, e) {
		...
		return It(t) ? a = {
			...
			e ? a[e] = t : a.milliseconds = t) : (o = Ki.exec(t)) ? (n = "-" === o[1] ? -1 : 1,
				a = {
					y: 0,
					d: g(o[xi]) * n,
					h: g(o[Ui]) * n,
					...
					a = {
						...
						m: ie(o[7], n),
						s: ie(o[8], n)
					}) : null == a ? a = {} : "object" == typeof a && ("from" in a || "to" in a) && (s = re(Ft(a.from), Ft(a.to)),
						a = {},
						a.ms = s.milliseconds,
						a.M = s.months),
			i = new Nt(a),
	...
	function re(t, e) {
		var n;
		return t.isValid() && e.isValid() ? (e = Et(e, t),
			t.isBefore(e) ? n = se(t, e) : (n = se(e, t),
	...
	function oe(t, e) {
		return function (n, i) {
			var s, r;
			return null === i || isNaN(+i) || (M(e, "moment()." + e + "(period, number) is deprecated. Please use moment()." + e + "(number, period)."),
				r = n,
				n = i,
				i = r),
	...
	function he(t, e) {
		var n = _(t) ? t : Ft(t);
		return this.isValid() && n.isValid() ? (e = H(c(e) ? "millisecond" : e),
	...
	function me(t, e) {
		var n, i = _(t) ? t : Ft(t);
		return this.isValid() && i.isValid() ? (e = H(e || "millisecond"),
	...
	function ge(t, e, n) {
		var i, s, r, a;
		return this.isValid() ? (i = Et(t, this),
			i.isValid() ? (s = 6e4 * (i.utcOffset() - this.utcOffset()),
				e = H(e),
				"year" === e || "month" === e || "quarter" === e ? (a = pe(this, i),
	...
	function Te(t) {
		var e;
		return void 0 === t ? this._locale._abbr : (e = P(t),
	...
	function ze(t, e, n, i, s) {
		var r;
		return null == t ? Mt(this, i, s).year : (r = St(t, i, s),
			e > r && (e = r),
			Ze.call(this, t, e, n, i, s))
	}
	function Ze(t, e, n, i, s) {
		var r = Dt(t, e, n, i, s)
	...
	function rn(t) {
		...
		return null != t ? (t = Ke(t, this.localeData()),
			this.add(t - e, "d")) : e
	}
	function an(t) {
		if (!this.isValid())
	...
	function Vn() {
		...
		return r >= 0 && a >= 0 && o >= 0 || 0 >= r && 0 >= a && 0 >= o || (r += 864e5 * Ln(In(o) + a),
			a = 0,
			o = 0),
	...
	function Jn(t, e) {
		return void 0 === As[t] ? !1 : void 0 === e ? As[t] : (As[t] = e,
			!0)
	}
	function Bn(t) {
	...
	E("S", 0, 0, function () {
		...
		q("SSS", gi, hi);
	var fs;
	for (fs = "SSSS"; fs.length <= 9; fs += "S")
		q(fs, Di);
	for (fs = "S"; fs.length <= 9; fs += "S")
		X(fs, mn);
...
!function (a, b) {
	...
	b.locale("en"),
		a.fn[d] = function (b, d) {
			return this.each(function () {
				a.data(this, e) ? ("function" == typeof a.data(this, e)[b] && a.data(this, e)[b](d),
					"destroy" === b && delete a.data(this, e)) : a.data(this, e, new c(this, b))
			}),
				this
		}
		,
		c.prototype = {
			...
			initDates: function () {
				if (this.$element.val().length > 0)
					"undefined" != typeof this.params.format && null !== this.params.format ? this.currentDate = b(this.$element.val(), this.params.format).locale(this.params.lang) : this.currentDate = b(this.$element.val()).locale(this.params.lang);
				else if ("undefined" != typeof this.$element.attr("value") && null !== this.$element.attr("value") && "" !== this.$element.attr("value"))
					"string" == typeof this.$element.attr("value") && ("undefined" != typeof this.params.format && null !== this.params.format ? this.currentDate = b(this.$element.attr("value"), this.params.format).locale(this.params.lang) : this.currentDate = b(this.$element.attr("value")).locale(this.params.lang));
				else if ("undefined" != typeof this.params.currentDate && null !== this.params.currentDate) {
					if ("string" == typeof this.params.currentDate)
						"undefined" != typeof this.params.format && null !== this.params.format ? this.currentDate = b(this.params.currentDate, this.params.format).locale(this.params.lang) : this.currentDate = b(this.params.currentDate).locale(this.params.lang);
				...
				if ("undefined" != typeof this.params.minDate && null !== this.params.minDate)
					if ("string" == typeof this.params.minDate)
						"undefined" != typeof this.params.format && null !== this.params.format ? this.minDate = b(this.params.minDate, this.params.format).locale(this.params.lang) : this.minDate = b(this.params.minDate).locale(this.params.lang);
				...
				if ("undefined" != typeof this.params.maxDate && null !== this.params.maxDate)
					if ("string" == typeof this.params.maxDate)
						"undefined" != typeof this.params.format && null !== this.params.format ? this.maxDate = b(this.params.maxDate, this.params.format).locale(this.params.lang) : this.maxDate = b(this.params.maxDate).locale(this.params.lang);
				...
				this.isAfterMinDate(this.currentDate) || (this.currentDate = b(this.minDate)),
					this.isBeforeMaxDate(this.currentDate) || (this.currentDate = b(this.maxDate))
			},
			initTemplate: function () {
				this.template = '<div class="dtp hidden" id="' + this.name + '"><div class="dtp-content"><div class="dtp-date-view"><header class="dtp-header"><div class="dtp-actual-day">Lundi</div><div class="dtp-close"><a href="javascript:void(0);"><span class="mdi mdi-close"></span></</div></header><div class="dtp-date hidden"><div><div class="left center p10"><a href="javascript:void(0);" class="dtp-select-month-before"><span class="mdi mdi-chevron-left"></span></a></div><div class="dtp-actual-month p80">MAR</div><div class="right center p10"><a href="javascript:void(0);" class="dtp-select-month-after"><span class="mdi mdi-chevron-right"></span></a></div><div class="clearfix"></div></div><div class="dtp-actual-num">13</div><div><div class="left center p10"><a href="javascript:void(0);" class="dtp-select-year-before"><span class="mdi mdi-chevron-left"></span></a></div><div class="dtp-actual-year p80">2014</div><div class="right center p10"><a href="javascript:void(0);" class="dtp-select-year-after"><span class="mdi mdi-chevron-right"></span></a></div><div class="clearfix"></div></div></div><div class="dtp-time hidden"><div class="dtp-actual-maxtime">23:55</div></div><div class="dtp-picker"><div class="dtp-picker-calendar"></div><div class="dtp-picker-datetime hidden"><div class="dtp-actual-meridien"><div class="left p20"><a class="dtp-meridien-am" href="javascript:void(0);">AM</a></div><div class="dtp-actual-time p60"></div><div class="right p20"><a class="dtp-meridien-pm" href="javascript:void(0);">PM</a></div><div class="clearfix"></div></div><div class="dtp-picker-clock"></div></div></div></div><div class="dtp-buttons group"><button class="dtp-btn-cancel btn btn-sm btn-primary">' + this.params.cancelText + '</button><button class="dtp-btn-ok btn btn-sm btn-primary">' + this.params.okText + '</button><div class="clearfix"></div></div></div></div>',
					a("body").find("#" + this.name).length <= 0 && (a("body").append(this.template),
			...
			initHours: function () {
				...
				setTimeout(function () {
					...
					b.showTime(b.currentDate),
						...
						b.currentDate.hour() < 12 ? b.$dtpElement.find("a.dtp-meridien-am").click() : b.$dtpElement.find("a.dtp-meridien-pm").click();
					for (var h = b.$dtpElement.find(".dtp-picker-clock").parent().parent().css("paddingLeft").replace("px", ""), i = b.$dtpElement.find(".dtp-picker-clock").parent().parent().css("paddingTop").replace("px", ""), j = b.$dtpElement.find(".dtp-picker-clock").css("marginLeft").replace("px", ""), k = b.$dtpElement.find(".dtp-picker-clock").css("marginTop").replace("px", ""), l = b.$dtpElement.find(".dtp-picker-clock").innerWidth() / 2, m = l / 1.2, n = [], o = 0; 12 > o; ++o) {
						...
						o == parseInt(s) && t.addClass("selected"),
							r.append(t),
							n.push(r)
					}
					b.$dtpElement.find("a.dtp-select-hour").off("click"),
						...
						b.toggleTime(!0),
						b.$dtpElement.find(".dtp-picker-clock").css("height", b.$dtpElement.find(".dtp-picker-clock").width() + (parseInt(i) + parseInt(k)) + "px"),
						b.initHands(!0)
				}, 300)
			},
			initMinutes: function () {
				...
				for (var b = this.$dtpElement.find(".dtp-picker-clock").parent().parent().css("paddingLeft").replace("px", ""), c = this.$dtpElement.find(".dtp-picker-clock").parent().parent().css("paddingTop").replace("px", ""), d = this.$dtpElement.find(".dtp-picker-clock").css("marginLeft").replace("px", ""), e = this.$dtpElement.find(".dtp-picker-clock").css("marginTop").replace("px", ""), f = this.$dtpElement.find(".dtp-picker-clock").innerWidth() / 2, g = f / 1.2, h = [], i = 0; 60 > i; i += 5) {
					...
					i == 5 * Math.round(this.currentDate.minute() / 5) && (m.addClass("selected"),
						this.currentDate.minute(i)),
						l.append(m),
						h.push(l)
				}
				this.$dtpElement.find("a.dtp-select-minute").off("click"),
					...
					this.toggleTime(!1),
					this.$dtpElement.find(".dtp-picker-clock").css("height", this.$dtpElement.find(".dtp-picker-clock").width() + (parseInt(c) + parseInt(e)) + "px"),
					this.initHands(!1),
					this._centerBox()
			},
			initHands: function (a) {
				...
				var b = this.$dtpElement.find(".dtp-picker-clock").parent().parent().css("paddingLeft").replace("px", "")
					, c = (this.$dtpElement.find(".dtp-picker-clock").parent().parent().css("paddingTop").replace("px", ""),
						this.$dtpElement.find(".dtp-picker-clock").css("marginLeft").replace("px", ""))
					, d = (this.$dtpElement.find(".dtp-picker-clock").css("marginTop").replace("px", ""),
			...
			animateHands: function () {
				...
				this.currentDate.minute(),
					...
					this.rotateElement(this.$dtpElement.find(".dtp-minute-hand"), 6 * (5 * Math.round(this.currentDate.minute() / 5)))
			},
			isAfterMinDate: function (a, c, d) {
				...
				if ("undefined" != typeof this.minDate && null !== this.minDate) {
					...
					c || d || (f.hour(0),
						...
						f.millisecond(0),
						g.millisecond(0),
						d ? e = parseInt(g.format("X")) >= parseInt(f.format("X")) : (g.minute(0),
							f.minute(0),
			...
			showDate: function (a) {
				a && (this.$dtpElement.find(".dtp-actual-day").html(a.locale(this.params.lang).format("dddd")),
			...
			showTime: function (a) {
				if (a) {
					...
					this.params.date ? this.$dtpElement.find(".dtp-actual-time").html(c) : (this.params.shortTime ? this.$dtpElement.find(".dtp-actual-day").html(a.format("A")) : this.$dtpElement.find(".dtp-actual-day").html(" "),
						this.$dtpElement.find(".dtp-actual-maxtime").html(c))
				}
			},
			selectDate: function (a) {
				a && (this.currentDate.date(a),
			...
			constructHTMLCalendar: function (a, c) {
				...
				for (var e = 0; e < c.week.length; e++)
					d += "<th>" + b(parseInt(c.week[e]), "d").locale(this.params.lang).format("dd").substring(0, 1) + "</th>";
				d += "</thead>",
					d += "<tbody><tr>";
				for (var e = 0; e < c.days.length; e++)
					e % 7 == 0 && (d += "</tr><tr>"),
						d += '<td data-date="' + b(c.days[e]).locale(this.params.lang).format("D") + '">',
						0 != c.days[e] && (d += this.isBeforeMaxDate(b(c.days[e]), !1, !1) === !1 || this.isAfterMinDate(b(c.days[e]), !1, !1) === !1 ? '<span class="dtp-select-day">' + b(c.days[e]).locale(this.params.lang).format("DD") + "</span>" : b(c.days[e]).locale(this.params.lang).format("DD") === b(this.currentDate).locale(this.params.lang).format("DD") ? '<a href="javascript:void(0);" class="dtp-select-day selected">' + b(c.days[e]).locale(this.params.lang).format("DD") + "</a>" : '<a href="javascript:void(0);" class="dtp-select-day">' + b(c.days[e]).locale(this.params.lang).format("DD") + "</a>",
							d += "</td>");
				return d += "</tr></tbody></table>"
			},
			setName: function () {
				for (var a = "", b = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", c = 0; 5 > c; c++)
			...
			setElementValue: function () {
				this.$element.trigger("beforeChange", this.currentDate),
					"undefined" != typeof a.material && this.$element.removeClass("empty"),
			...
			toggleButtons: function (a) {
				if (a && a.isValid()) {
					...
					this.isAfterMinDate(c, !1, !1) ? this.$dtpElement.find("a.dtp-select-month-before").removeClass("invisible") : this.$dtpElement.find("a.dtp-select-month-before").addClass("invisible"),
						this.isBeforeMaxDate(d, !1, !1) ? this.$dtpElement.find("a.dtp-select-month-after").removeClass("invisible") : this.$dtpElement.find("a.dtp-select-month-after").addClass("invisible");
					var e = b(a).locale(this.params.lang).startOf("year")
						, f = b(a).locale(this.params.lang).endOf("year");
					this.isAfterMinDate(e, !1, !1) ? this.$dtpElement.find("a.dtp-select-year-before").removeClass("invisible") : this.$dtpElement.find("a.dtp-select-year-before").addClass("invisible"),
						this.isBeforeMaxDate(f, !1, !1) ? this.$dtpElement.find("a.dtp-select-year-after").removeClass("invisible") : this.$dtpElement.find("a.dtp-select-year-after").addClass("invisible")
				}
			},
				...
				if (c) {
					...
					this.$dtpElement.find("a.dtp-select-hour").each(function () {
						...
						e.hour(d.convertHours(c)).minute(0).second(0),
							d.isAfterMinDate(e, !0, !1) === !1 || d.isBeforeMaxDate(e, !0, !1) === !1 ? (a(this).prop("disabled"),
								a(this).addClass("disabled")) : a(this).on("click", d._onSelectHour.bind(d))
					})
				} else {
					...
					this.$dtpElement.find("a.dtp-select-minute").each(function () {
						var c = a(this).data("minute")
							, e = b(d.currentDate);
						e.minute(c).second(0),
							d.isAfterMinDate(e, !0, !0) === !1 || d.isBeforeMaxDate(e, !0, !0) === !1 ? (a(this).prop("disabled"),
								a(this).addClass("disabled")) : a(this).on("click", d._onSelectMinute.bind(d))
					})
				}
			},
			...
			_onClick: function () {
				this.currentView = 0,
					...
					this.initDates(),
					this.show(),
					this.params.date ? (this.$dtpElement.find(".dtp-date").removeClass("hidden"),
						this.initDate()) : this.params.time && (this.$dtpElement.find(".dtp-time").removeClass("hidden"),
							this.initHours())
			},
			...
			_onOKClick: function () {
				switch (this.currentView) {
					case 0:
						this.params.time === !0 ? this.initHours() : (this.setElementValue(),
							this.hide());
						break;
					case 1:
						this.initMinutes();
			...
			show: function () {
				var a = this;
				setTimeout(function () {
					a.$dtpElement.removeClass("hidden"),
						a._centerBox()
				}, 300)
			},
			hide: function () {
